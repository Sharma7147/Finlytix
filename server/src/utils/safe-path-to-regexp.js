...
function* lexer(str) {
    ...
    function name() {
        ...
        // Robust handling for unnamed parameters
        if (!value) {
            value = `param_${i}`;
            console.warn(`[path-to-regexp] Unnamed parameter at position ${i}, using default name "${value}"`);
        }
